    ...
    class << self
      ...
      def tweet_data
        [
          ...
          'Reversalでは投稿動画・ページ・まとめ・イベントに対して、良いと思ったものにGoodと送ることができます。
Goodされたユーザは自分のコンテンツの評価が分かり、またコンテンツ毎にGood数とGoodしたユーザが表示されます。 http://twitter.com/ftg_reversal/status/752125742310318090/photo/1'
        ]
      end
