    ...
    class << self
      ...
      def tweet_data
        [
          ...
          '【宣伝】Reversalでは動画・ページ・まとめ・イベントで良いと思ったものにGoodと送ることができます。Goodされたユーザは自分のコンテンツの評価が分かり、またコンテンツ毎にGood数とGoodしたユーザが表示されます。 http://twitter.com/ftg_reversal/status/752125742310318090/photo/1',
          '【宣伝】Reversalに収集された動画に対して、対戦の組み合わせと対戦開始時間を編集する機能を追加しました。ユーザーの皆様に編集していただくことで、これまで以上に、より正確な対戦組み合わせを表示することが出来ます。 http://twitter.com/ftg_reversal/status/752695160375422976/photo/1'
        ]
      end
